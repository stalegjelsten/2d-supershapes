...
class SuperShape {
  ...
  calcRadius(theta) {
    ...
    this.equation = "r = \\left({\\left\\lvert \\frac{\\cos{\\left(\\frac{" + this.m.toPrecision(2) + "}{4} \\theta\\right)}}{" + this.a.toPrecision(2) + "} \\right\\rvert ^{" + this.n2.toPrecision(2) + "}"
    this.equation += "+ \\left\\lvert \\frac{\\sin{\\left(\\frac{" + this.m.toPrecision(2) + "}{4} \\theta\\right)}}{" + this.b.toPrecision(2) + "} \\right\\rvert ^{" + this.n3.toPrecision(2) + "}}\\right)^{-\\frac{1}{" + this.n1.toPrecision(2) + "}}"
