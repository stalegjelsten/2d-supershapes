...
function setup() {
  ...
  gui.add(myShape, "n1", 0, 10, 0.1).onChange(redraw)
  gui.add(myShape, "n2", 0, 10, 0.1).onChange(redraw)
  gui.add(myShape, "n3", 0, 10, 0.1).onChange(redraw)
  gui.add(myShape, "a", 1, 10, 1).onChange(redraw)
  gui.add(myShape, "b", 1, 10, 1).onChange(redraw)
  ...
  plainTextEqn.style('margin', "15px")
...
class SuperShape {
  ...
  display() {
    ...
    plainTextEqn.html("LaTeX code for the equation: <br /><code>" + this.equation + "</code>")
  }
}
